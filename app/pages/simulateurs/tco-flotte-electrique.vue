...
const panneaux = computed<Panneau[]>(() => [
  ...
  },
  {
    ...
    champs: [
      ...
      { cle: 'ecoScoreVE', label: 'VE éligible au score environnemental', options: { inconnu: 'Je ne sais pas', oui: 'Oui', non: 'Non' }, aide: 'Conditionne l\'abattement de 70 % sur l\'avantage en nature, plafonné à 4 641,60 € en 2026. Sans réponse, il n\'est pas appliqué : mieux vaut surestimer un coût employeur que l\'annoncer trop bas.', defaut: () => 'inconnu' },
