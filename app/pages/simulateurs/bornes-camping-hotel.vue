  ...
  <section class="section section--tight chr-seo"><div class="wrap">
    ...
    <div class="article-body">
      <div class="article-tldr">
        ...
        <ul>
          <li>Une <strong>exemption existe</strong>&nbsp;: l'article L113-14 du code de la construction écarte de l'obligation les parcs dépendant de bâtiments <strong>possédés et occupés par une PME</strong> au sens de la recommandation 2003/361/CE. De nombreux campings et hôtels indépendants peuvent en bénéficier, à condition de remplir les trois critères — propriété, occupation et taille.</li>
      ...
      <div class="article-callout">
        ...
        <p>Une nuit de douze heures à 7,4 kW représente jusqu'à <strong>88,8 kWh appelés au réseau</strong>, soit environ 80 kWh rendus à la batterie — bien plus qu'un client n'en a besoin. Sur un séjour, <strong>la durée de stationnement remplace la puissance</strong>&nbsp;: multiplier les bornes rapides coûte cher sans servir davantage de clients. Et tous les véhicules n'acceptent pas 22 kW en courant alternatif.</p>
      </div>
      ...
      <div class="article-faq">
        ...
        <details><summary>Un camping est-il obligé d'installer des bornes de recharge&nbsp;?</summary><div class="faq-a">Pas nécessairement. L'article L113-14 du code de la construction et de l'habitation écarte de l'obligation les parcs dépendant de bâtiments possédés et occupés par une PME au sens de la recommandation européenne 2003/361/CE&nbsp;: de nombreux campings et hôtels indépendants peuvent en bénéficier lorsqu'ils remplissent les trois conditions — propriété, occupation et qualification de PME. L'obligation de l'article L113-13 — un point par tranche de vingt places depuis le 1ᵉʳ janvier 2025 — vise les autres.</div></details>
      ...
      <hr>
      <p class="disclaimer">Estimation préalable, indicative et non contractuelle. Textes réglementaires et état des guichets d'aide vérifiés le 05/08/2026. Les coûts de matériel, de génie civil et les prix de l'énergie sont des hypothèses OTONOM revues le 05/08/2026, la grille de prix de l'électricité étant celle du 01/01/2026&nbsp;; toutes sont affichées et paramétrables, les valeurs réelles dépendent de votre site et se confirment par devis. Les projections de parc rechargeable sont des hypothèses de travail, non des prévisions.</p>
    </div>
  </div></section>
</template>
