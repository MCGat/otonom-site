  ...
  <section class="section section--tight chr-seo"><div class="wrap">
    ...
    <div class="article-body">
      <div class="article-tldr">
        ...
        <ul>
          <li>L'obligation d'équipement <strong>ne vise pas les PME</strong>&nbsp;: l'article L113-14 du code de la construction écarte les parcs dépendant de bâtiments possédés et occupés par une PME au sens de la recommandation 2003/361/CE. De nombreux campings et hôtels indépendants peuvent en bénéficier, à condition de remplir les trois critères — propriété, occupation et taille.</li>
